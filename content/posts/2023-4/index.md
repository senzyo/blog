...
```bash
yay -S 7-zip-full aria2 firefox git inkscape joplin-desktop kclock ntfs-3g telegram-desktop unrar visual-studio-code-bin vlc wps-office wps-office-mui-zh-cn ttf-wps-fonts
```
...
3. [System maintenance](https://wiki.archlinux.org/title/System_maintenance)
4. [Environment variables](https://wiki.archlinux.org/title/Environment_variables)
5. [List of applications](https://wiki.archlinux.org/title/List_of_applications)
6. [Pacman](https://wiki.archlinux.org/title/Pacman)
7. [Pacman/Tips_and_tricks](https://wiki.archlinux.org/title/Pacman/Tips_and_tricks)
{{< /admonition >}}
