...
由于 sing-box 不像 clash 那样支持 `proxy-providers`, 所以只能使用“远端转换程序请求订阅信息并根据模板生成配置文件、本地下载配置文件”的方式, 梦回 subconverter 时期。

但是目前 [tindy2013/subconverter](https://github.com/tindy2013/subconverter) 及其二开 [asdlokj1qpi23/subconverter](https://github.com/asdlokj1qpi23/subconverter) 对于 sing-box 的支持性暂时不是很好, 好在还有另外一个好用的: [Toperlock/sing-box-subscribe](https://github.com/Toperlock/sing-box-subscribe)。

Fork [Toperlock/sing-box-subscribe](https://github.com/Toperlock/sing-box-subscribe) 后在 [Vercel](https://vercel.com/new) 部署。然后创建一个 GitHub 仓库, 存放一些自定义模板, 比如: [senzyo/sing-box-templates](https://github.com/senzyo/sing-box-templates), 然后参考 [使用示例](#使用示例) 拼接出自己的 `download_url` 使用即可。

{{< admonition type=tip title="注意" open=true >}}
后文内容全是 [senzyo/sing-box-templates](https://github.com/senzyo/sing-box-templates) 的 [README](https://github.com/senzyo/sing-box-templates/blob/master/README.md)。
{{< /admonition >}}
